...
compute_capabilities = {cap.split("+")[0] for cap in os.getenv("TORCH_CUDA_ARCH_LIST", "").split(";")}
compute_capabilities = compute_capabilities.intersection(SUPPORTED_ARCHS)
